...
export API_URL="https://api.67eed81a71917a5408c1b409.ocp.techzone.ibm.com:6443"

# Get this from "Reservation Details: Bastion Password"
BASTION_PASSWD="FlivLwzx"

# Get this from "Reservation Details: Bastion SSH connection"
SSH_CONNECTION="ssh itzuser@api.67eed81a71917a5408c1b409.ocp.techzone.ibm.com -p 40222"

# Get this from "Reservation Details: Cluster Admin Password"
export CLUSTER_ADMIN_PWD="RHqxZ-pUcVr-t7TNs-cKPjP"
...
TOKEN="sha256~EXkte7dgir-oImdbqqv0cgZ15-9grCfmWuGGDIvTST0"
