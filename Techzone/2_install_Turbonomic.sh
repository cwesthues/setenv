...
export API_URL="https://api.67f04f3d71917a5408c1b6a6.ocp.techzone.ibm.com:6443"

# Get this from "Reservation Details: Bastion Password"
BASTION_PASSWD="bPBgkC2X"

# Get this from "Reservation Details: Bastion SSH connection"
SSH_CONNECTION="ssh itzuser@api.67f04f3d71917a5408c1b6a6.ocp.techzone.ibm.com -p 40222"

# Get this from "Reservation Details: Cluster Admin Password"
export CLUSTER_ADMIN_PWD="uNhLu-dRbi9-KHtpj-J9udA"
...
TOKEN="sha256~3tb4lmJuSXfNyZPodtaSaVSrlJaW9xUjZNysdbIiDc4"
